...
class PageRechercheStations extends StatefulWidget {
  final Position? position;
  PageRechercheStations({Key? key, required this.position}) : super(key: key);

  @override
  _PageRechercheStationsState createState() => _PageRechercheStationsState();
}

BehaviorSubject _bhvsRecherche = BehaviorSubject.seeded('');

class _PageRechercheStationsState extends State<PageRechercheStations> {
