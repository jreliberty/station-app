...
class PassNotSelectedCard extends StatefulWidget {
  final Contact contact;
  PassNotSelectedCard({Key? key, required this.contact}) : super(key: key);

  @override
  _PassNotSelectedCardState createState() => _PassNotSelectedCardState();
}

class _PassNotSelectedCardState extends State<PassNotSelectedCard> {
  @override
        ...
        onTap: () {
          try {
            var cart = (BlocProvider.of<FastCartBloc>(context).state
                ...
                .cart;
            cart.addContact(widget.contact);
        ...
        child: Card(
          ...
          child: Container(
            decoration: BoxDecoration(
                ...
                color: ColorsApp.BackgroundPrimary),
            height: 205,
            child: Padding(
